        ...
        <div className="overflow-hidden">
            ...
            <div className="login">
                ...
                <section id="login-form">
                    <h1 className="space-grotesk" style={{ zIndex: 100, fontSize: "30px" }}>Set up your account</h1>
                    <p className="space-grotesk" style={{ zIndex: 100 }}>Please complete all information to create your account on Capsule</p>
                    <br />
                    <form onSubmit={handleSubmit} autoComplete="off">
                        <div className="input-group">
                            ...
                            />
                            <label htmlFor="name" className="placeholder" style={{ color: "hsla(0, 0%, 100%, 0.7)", marginLeft: "20px", marginTop: "5px" }}>
                                Name
                            </label>
                        </div>
                        <div className="input-group">
                    ...
                    <p id="fineprint-agree">
                        ...
                        />
                        Agree to the <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Terms of Service</a> & <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Privacy Policy</a>
                    </p>
                </section>
            </div>
        </div>
