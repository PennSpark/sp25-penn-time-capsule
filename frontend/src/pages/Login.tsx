        ...
        <section id="login-form">
          ...
          <form onSubmit={handleSubmit} autoComplete="off">g
            ...
            <div className="input-group relative">
              ...
              >
                <svg className="svg-eye" width="18" height="18" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p id="signup-redirect">
            ...
            <p id="fineprint">By signing in, you agree to our <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Terms of Service</a> and acknowledge that our <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Privacy Policy</a> applies to you.</p>
            </section>
        </div>
        </div>
